...
public class XListView2 extends ListView implements OnScrollListener {
  ...
  protected final static int SCROLL_BACK_HEADER = 0;
  protected final static int SCROLL_BACK_FOOTER = 1;

  protected final static int SCROLL_DURATION = 400;

  // when pull up >= 50px
  protected final static int PULL_LOAD_MORE_DELTA = 50;
  ...
  protected IXListViewListener mListener;

  protected XHeaderView mHeader;
