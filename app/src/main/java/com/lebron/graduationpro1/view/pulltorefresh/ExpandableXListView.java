 ...
 * @date 2013-10-08
 */
public class ExpandableXListView extends ExpandableListView
  ...
  private final boolean mIsHeaderReady = false;
  ...
  private IExpandableXListViewListener mListener;
  ...
  public ExpandableXListView(Context context, AttributeSet attrs) {
    super(context, attrs);
    initWithContext(context);
  }
  ...
  public void setPullLoadEnable(boolean enable) {
    ...
    if (mEnablePullLoad && !mIsFooterReady) {
      mIsFooterReady = true;
  ...
  public void setFull() {
    ...
    mFooterView.setBottomMargin(0);
    mFooterView.show();
    mFooterView.setState(XFooterView.STATE_FULL);
    mFooterView.setOnClickListener(null);
  }

  public void setFull(String str) {
    setFull();
    mFooterView.setFullText(str);
  }
   ...
   * @param listener
   */
  public void setExpandableXListViewListener(
      IExpandableXListViewListener listener) {
    mListener = listener;
  }
   ...
   * @author markmjw
   */
  public interface IExpandableXListViewListener {
